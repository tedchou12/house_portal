...
class Date_Calc
{
    ...
    function beginOfPrevQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    } // end func beginOfPrevQuarter
	
    function endOfPrevQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfThisQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function endOfThisQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfNextQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function endOfNextQuarter($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfPrevYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    } // end func beginOfLastYear

    function endOfPrevYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    function beginOfThisYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    function endOfThisYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    function beginOfNextYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    function endOfNextYear($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
    ...
    */
    ...
    function beginOfDay($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfLast7Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
		...
		$days = Date_Calc::dateToDays($day,$month,$year) - 7;
		
		return Date_Calc::daysToDate($days,$format);	
	}
	
    function endOfLast7Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth	
	
    function beginOfLast30Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
		...
		$days = Date_Calc::dateToDays($day,$month,$year) - 30;
		
		return Date_Calc::daysToDate($days,$format);        
	}
	
    function endOfLast30Day($day="",$month="",$year="",$format="%Y%m%d")
    {
		return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth
	
    function beginOfLast60Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
		...
		$days = Date_Calc::dateToDays($day,$month,$year) - 60;
		
		return Date_Calc::daysToDate($days,$format);	
	}
	
    function endOfLast60Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth
	
    function beginOfLast90Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
		...
		$days = Date_Calc::dateToDays($day,$month,$year) - 90;
		
		return Date_Calc::daysToDate($days,$format);
	}
	
    function endOfLast90Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth
	
    function beginOfNext7Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
	}
	
    function endOfNext7Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfNext30Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
	}
	
    function endOfNext30Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfNext60Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth
	
    function endOfNext60Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function beginOfNext90Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        return Date_Calc::beginOfDay($day, $month, $year, $format);
    } // end of func beginOfMonth
	
    function endOfNext90Day($day="",$month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
    ...
    function endOfMonth($month="",$year="",$format="%Y%m%d")
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
...
*/
	...
	function endOfNextWeek($day="",$month="",$year="",$format="%Y%m%d",$fdow=null) {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
            $month = Date_Calc::dateNow("%m");
		...
		$next_week = Date_Calc::beginOfNextWeek($day,$month,$year,$format,$fdow);
		
        $next_week_year = substr($next_week,0,4);
        $next_week_month = substr($next_week,4,2);
        $next_week_day = substr($next_week,6,2);

		return Date_Calc::endOfWeek($next_week_day, $next_week_month, $next_week_year, $format, $fdow);
    ...
    function beginOfNextWeek($day="",$month="",$year="",$format="%Y%m%d",$fdow=null)
    {
        ...
        $date = Date_Calc::daysToDate(Date_Calc::dateToDays($day,$month,$year)+7,"%Y%m%d");
	...
	function endOfPrevWeek($day="",$month="",$year="",$format="%Y%m%d",$fdow=null) {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
            $month = Date_Calc::dateNow("%m");
		...
		$prev_week = Date_Calc::beginOfPrevWeek($day,$month,$year,$format,$fdow);
		
        $prev_week_year = substr($prev_week,0,4);
        $prev_week_month = substr($prev_week,4,2);
        $prev_week_day = substr($prev_week,6,2);

		return Date_Calc::endOfWeek($prev_week_day, $prev_week_month, $prev_week_year, $format, $fdow);
    ...
    function getWeekdayAbbrname($day="",$month="",$year="",$length=2)
    {
        if(empty($year))
            $year = Date_Calc::dateNow("%Y");
        if(empty($month))
		...
		$dayname = Date_Calc::getWeekdayFullname($day,$month,$year);
		
		if (mb_strlen($dayname) == 3)
			return mb_substr($dayname,-1,1);
		else
			return substr($dayname,0,$length);
    } // end func getWeekdayFullname
